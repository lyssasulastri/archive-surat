...
if($pdf = false) {
?>
   <a class="dropdown-item" aria-current="page" onclick="window.open('<?php echo site_url('C_Dashboard/printpdf_sm') ?>', 'blank')" href="#"><b>Print</b></a>
<?php } ?>
...
<h2 style="margin-left: 30px;">Laporan Surat masuk</h2>
